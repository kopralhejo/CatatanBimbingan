...
//    }
    ...
    public void onCreate(SQLiteDatabase db){
        String sql = "create table Mahasiswa(id integer primary key, nim text null, nama text null, hp text null, prodi text null,jurusan text null, angkatan text null, jumlahbimbingan text null, tanggal text null);";
    ...
    public void onUpgrade(SQLiteDatabase arg0, int arg1, int arg2){
        arg0.execSQL(" DROP TABLE IF EXISTS " + TABLE_Mahasiswa);
    }
}
